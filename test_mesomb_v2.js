...
console.log('════════════════════════════════════════════════════════════════');
console.log('🧪 Testing MeSomb API - V2 (x-mesomb-signature header)');
console.log('════════════════════════════════════════════════════════════════');
console.log('');
...
console.log('   Headers:');
console.log(`     X-MeSomb-Application: ${appKey}`);
console.log(`     X-MeSomb-Date: ${date}`);
console.log(`     X-MeSomb-Nonce: ${nonce}`);
console.log(`     X-MeSomb-Signature: ${signature.substring(0, 20)}...`);
console.log('');

// Envoyer requête - Essai avec X-MeSomb-Signature au lieu de Authorization
const options = {
  ...
  headers: {
    ...
    'X-MeSomb-Signature': signature,  // Changé de Authorization à X-MeSomb-Signature
